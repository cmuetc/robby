 ...
 * Slug: robby/footer-three-columns
 * Categories: footer
...
<!-- wp:paragraph -->
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'robby' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'robby' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'robby' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'robby' ); ?></a></p>
<!-- /wp:paragraph -->
