 ...
 * Slug: robby/footer-default-dark
 * Categories: footer
...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'robby' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'robby' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Facebook', 'robby' ); ?></a> · <a href="#"><?php echo esc_html__( 'Twitter', 'robby' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'robby' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
