...
<p><?php echo esc_html__( 'Item #1', 'robby' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '100%', 'robby' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #2', 'robby' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '90%', 'robby' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #3', 'robby' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '80%', 'robby' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #4', 'robby' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '70%', 'robby' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #5', 'robby' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '60%', 'robby' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #6', 'robby' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '50%', 'robby' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
